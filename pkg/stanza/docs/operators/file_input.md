...
| `fingerprint_include_path`      | `false`                              | Whether to prefix the fingerprint with the file path to reduce collisions between files with identical leading bytes. The `fingerprint_size` applies to file content only.                                                                                      |

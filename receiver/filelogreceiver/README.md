...
| `fingerprint_deduplication`           | `true`                               | Whether to deduplicate files by fingerprint within a poll cycle. Disable to read multiple files that share the same fingerprint; may impact offset tracking for identical files.                                                    |
